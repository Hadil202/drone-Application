...
class Root:
    ...
    if sys.platform.startswith('win'):
        ...
        logo = PhotoImage(file='C:/Users/chebab/Pictures/Reconnaissance_Facial-main/icons/img_par_defaut.png')
        root.tk.call('wm', 'iconphoto', root, logo)

    image_background = PIL.ImageTk.PhotoImage(PIL.Image.open("C:/Users/chebab/Pictures/Reconnaissance_Facial-main/images/image_background.png"))
    video_background = PIL.ImageTk.PhotoImage(PIL.Image.open("C:/Users/chebab/Pictures/Reconnaissance_Facial-main/images/video_background.png"))
    cross = PIL.ImageTk.PhotoImage(PIL.Image.open("C:/Users/chebab/Pictures/Reconnaissance_Facial-main/images/cross.png"))
    refresh = PIL.ImageTk.PhotoImage(PIL.Image.open('C:/Users/chebab/Pictures/Reconnaissance_Facial-main/images/refresh.png'))
...
class AboutButton:
    ...
    def showAbout(self):
        ...
        about = "Projet de fin d'étude à la faculté polydiciplanaire Ouarzazate l'année 202/2023\n" \
